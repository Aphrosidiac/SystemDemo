    ...
    <template v-else-if="profile">
      ...
      <div v-if="profile.role === 'ADMIN'" class="bg-dark-900 border border-dark-800 rounded-xl p-6 mb-6">
        ...
        <form @submit.prevent="handleUpdateBranch" class="space-y-4">
          ...
          <div class="grid sm:grid-cols-2 gap-4">
            <BaseInput v-model="branchForm.bankName" label="Bank Name" placeholder="e.g. DEMO BANK" />
            <BaseInput v-model="branchForm.bankAccount" label="Bank Account Number" placeholder="e.g. 0000 0000 0000" />
          </div>
