  ...
  <div>
    ...
    <div id="payment-log-print" class="hidden print:block text-gray-900" style="width: 800px;">
      ...
      <div class="bg-gray-900 text-white px-8 py-5 flex items-center gap-4">
        <img src="/logo-doc.svg" alt="SystemDemo" class="h-14" />
        <div class="flex-1">
          <h1 class="text-lg font-bold text-yellow-400">SYSTEMDEMO</h1>
          <p class="text-gray-300 text-xs mt-1">Suite 12-3, Demo Plaza, Jalan Contoh 1, 50000 Kuala Lumpur</p>
          <p class="text-gray-300 text-xs">Tel: +60 3-1234 5678</p>
        </div>
      </div>
      ...
      <div class="bg-yellow-400 px-8 py-3 text-center border-t border-gray-200">
        <p class="text-gray-800 text-sm font-medium">SystemDemo — Payment Log</p>
      </div>
    </div>
  </div>
</template>
...
async function exportPdf() {
  ...
  doc.text('SYSTEMDEMO', 14, 12)
  doc.setTextColor(200, 200, 200)
  doc.setFontSize(8)
  doc.setFont('helvetica', 'normal')
  doc.text('Suite 12-3, Demo Plaza, Jalan Contoh 1, 50000 Kuala Lumpur', 14, 18)
  doc.text('Tel: +60 3-1234 5678', 14, 23)
  ...
  doc.setFontSize(7)
  doc.setFont('helvetica', 'normal')
  doc.text('SystemDemo — Payment Log', pw / 2, ph - 5, { align: 'center' })
